...
public class lluviasContinuacion08 {
    ...
    public static int primerDia (double v[], double x){
        int num = 0;
        for (int i = 0; i < v.length; i++) {
            v[i] = num;
            if (v[i] == x) {
    ...
    public static int ultimoDia (double v[], double x){
        int num = 0;
        for (int i = 0; i < v.length; i--) {
            v[i] = num;
            if (v[i] == x) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(primerDia(lluvias, 19) == -1?"no hay ningún dia con 19 litros.":"cayeron 19 litros el dia "+primerDia(lluvias, 19));
        System.out.println(ultimoDia(lluvias, 19) == -1?"no hay ningún dia con 19 litros.":"cayeron 19 litros el dia "+ultimoDia(lluvias, 19));
    }
}
